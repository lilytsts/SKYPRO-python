...
# print (100 // 2)# получение целой части 

# Строки кодируем
# for i in "PYTHON":
#     print(f'{i} = {ord(i)}, {bin(ord(i))}')

# for i in (80, 121, 116, 10, 104, 111, 110): # 10 - перенос строки, 91, 93 - скобочки
#     print(chr (i), end=' ')
...
#     for y in range (5):
#       if data[x + y * 5] == '1':
#         draw.rectangle ((x*10, y*10, x*10 + 9, y*10 + 9), fill ='black') # Рисуем включенные чёрным

# for i in range (255): # Шкала серого
#     draw.rectangle((i*3, 60, i*3+2, 70), fill=(i, i, i)) # red = green = blue = gray
